...
import { 
  ...
  Loader2, Trash2, Edit3, Search, Tag, DollarSign, 
  Boxes, ChevronDown, ChevronUp, FileText, Filter, LogOut, TrendingUp, Lock
} from 'lucide-react';

function App({ keycloak }: { keycloak: any }) {
  // --- VERIFICAÇÃO DE PERMISSÕES ---
  const isAdmin = keycloak.hasResourceRole('admin') || keycloak.hasRealmRole('admin');
  const isViewer = keycloak.hasResourceRole('viewer') || keycloak.hasRealmRole('viewer');
